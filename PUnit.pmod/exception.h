...
//!
//! Provides: assert_throws, assert_throws_fn, assert_no_throw, assert_throws_message
...
#define assert_throws_message(error_type, expected_message, fn) PUnit.assert_throws_message((error_type), (expected_message), (fn), 0, UNDEFINED, __FILE__ + ":" + __LINE__)
